...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(select(uint4(0x9F090439u, 0x5E9F85C9u, 0x8C4CA03Fu, 0xB8D969EDu), uint4(0xAC5DB57Bu, 0xA91A02EDu, 0xB3C49313u, 0xF43A9ABBu), v.c0) + 
                        select(uint4(0x84E7E01Bu, 0x8E055BE5u, 0x6E624EB7u, 0x7383ED49u), uint4(0xDD49C23Bu, 0xEBD0D005u, 0x91475DF7u, 0x55E84827u), v.c1) + 
                        select(uint4(0x90A285BBu, 0x5D19E1D5u, 0xFAAF07DDu, 0x625C45BDu), uint4(0xC9F27FCBu, 0x6D2523B1u, 0x6E2BF6A9u, 0xCC74B3B7u), v.c2));
        }
        ...
        {
            return (select(uint4(0x83B58237u, 0x833E3E29u, 0xA9D919BFu, 0xC3EC1D97u), uint4(0xB8B208C7u, 0x5D3ED947u, 0x4473BBB1u, 0xCBA11D5Fu), v.c0) + 
                    select(uint4(0x685835CFu, 0xC3D32AE1u, 0xB966942Fu, 0xFE9856B3u), uint4(0xFA3A3285u, 0xAD55999Du, 0xDCDD5341u, 0x94DDD769u), v.c1) + 
                    select(uint4(0xA1E92D39u, 0x4583C801u, 0x9536A0F5u, 0xAF816615u), uint4(0x9AF8D62Du, 0xE3600729u, 0x5F17300Du, 0x670D6809u), v.c2));
        }
