...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(asuint(v.c0) * uint4(0x58399E77u, 0x5EAC29C9u, 0xFC6014F9u, 0x6BF6693Fu) +
                        asuint(v.c1) * uint4(0x9D1B1D9Bu, 0xF842F5C1u, 0xA47EC335u, 0xA477DF57u)) + 0xC4B1493Fu;
        }
        ...
        {
            return (asuint(v.c0) * uint4(0xBA0966D3u, 0xAFBEE253u, 0x5B419C01u, 0x515D90F5u) +
                    asuint(v.c1) * uint4(0xEC9F68F3u, 0xF9EA92D5u, 0xC2FAFCB9u, 0x616E9CA1u)) + 0xC5C5394Bu;
        }
