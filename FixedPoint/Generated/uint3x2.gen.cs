...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(v.c0 * uint3(0x9536A0F5u, 0xAF816615u, 0x9AF8D62Du) +
                        v.c1 * uint3(0xE3600729u, 0x5F17300Du, 0x670D6809u)) + 0x7AF32C49u;
        }
        ...
        {
            return (v.c0 * uint3(0xAE131389u, 0x5D1B165Bu, 0x87096CD7u) +
                    v.c1 * uint3(0x4C7F6DD1u, 0x4822A3E9u, 0xAAC3C25Du)) + 0xD21D0945u;
        }
