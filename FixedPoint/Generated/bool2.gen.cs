...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(select(uint2(0xB8B208C7u, 0x5D3ED947u), uint2(0x4473BBB1u, 0xCBA11D5Fu), v));
        }
        ...
        {
            return (select(uint2(0x685835CFu, 0xC3D32AE1u), uint2(0xB966942Fu, 0xFE9856B3u), v));
        }
