...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(v.c0 * uint3(0xAFBEE253u, 0x5B419C01u, 0x515D90F5u) +
                        v.c1 * uint3(0xEC9F68F3u, 0xF9EA92D5u, 0xC2FAFCB9u) +
                        v.c2 * uint3(0x616E9CA1u, 0xC5C5394Bu, 0xCAE78587u)) + 0x7A1541C9u;
        }
        ...
        {
            return (v.c0 * uint3(0xF83BD927u, 0x6A243BCBu, 0x509B84C9u) +
                    v.c1 * uint3(0x91D13847u, 0x52F7230Fu, 0xCF286E83u) +
                    v.c2 * uint3(0xE121E6ADu, 0xC9CA1249u, 0x69B60C81u)) + 0xE0EB6C25u;
        }
