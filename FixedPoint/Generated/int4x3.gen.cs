...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return (asuint(v.c0) * uint4(0xAF642BA9u, 0xA8F2213Bu, 0x9F3FDC37u, 0xAC60D0C3u) +
                    asuint(v.c1) * uint4(0x9263662Fu, 0xE69626FFu, 0xBD010EEBu, 0x9CEDE1D1u) +
                    asuint(v.c2) * uint4(0x43BE0B51u, 0xAF836EE1u, 0xB130C137u, 0x54834775u)) + 0x7C022221u;
        }
