    ...
    public static partial class MathFp
    {
        ...
        public static uint hash(bool3x3 v)
        {
            return csum(select(uint3(0xF648BEABu, 0x6BDB2B07u, 0xEF63C699u), uint3(0x9001903Fu, 0xA895B9CDu, 0x9D23B201u), v.c0) + 
                        ...
                        select(uint3(0x4DDC6509u, 0x7CF083CBu, 0x5C4D6CEDu), uint3(0xF9137117u, 0xE857DCE1u, 0xF62213C5u), v.c2));
        }
        ...
        {
            return (select(uint3(0x9CDAA959u, 0xAA269ABFu, 0xD54BA36Fu), uint3(0xFD0847B9u, 0x8189A683u, 0xB139D651u), v.c0) + 
                    select(uint3(0xE7579997u, 0xEF7D56C7u, 0x66F38F0Bu), uint3(0x624256A3u, 0x5292ADE1u, 0xD2E590E5u), v.c1) + 
                    select(uint3(0xF25BE857u, 0x9BC17CE7u, 0xC8B86851u), uint3(0x64095221u, 0xADF428FFu, 0xA3977109u), v.c2));
        }
