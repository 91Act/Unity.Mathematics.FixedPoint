...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(select(uint4(0xAF0F3103u, 0xE4A056C7u, 0x841D8225u, 0xC9393C7Du), uint4(0xD42EAFA3u, 0xD9AFD06Du, 0x97A65421u, 0x7809205Fu), v));
        }
        ...
        {
            return (select(uint4(0x9C9F0823u, 0x5A9CA13Bu, 0xAFCDD5EFu, 0xA88D187Du), uint4(0xCF6EBA1Du, 0x9D88E5A1u, 0xEADF0775u, 0x747A9D7Bu), v));
        }
