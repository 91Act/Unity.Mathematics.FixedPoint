...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(select(uint4(0x4B01D3E1u, 0x7461CA0Du, 0x79725379u, 0xD6258E5Bu), uint4(0xEE390C97u, 0x9C8A2F05u, 0x4DDC6509u, 0x7CF083CBu), v.c0) + 
                        select(uint4(0x5C4D6CEDu, 0xF9137117u, 0xE857DCE1u, 0xF62213C5u), uint4(0x9CDAA959u, 0xAA269ABFu, 0xD54BA36Fu, 0xFD0847B9u), v.c1));
        }
        ...
        {
            return (select(uint4(0x8189A683u, 0xB139D651u, 0xE7579997u, 0xEF7D56C7u), uint4(0x66F38F0Bu, 0x624256A3u, 0x5292ADE1u, 0xD2E590E5u), v.c0) + 
                    select(uint4(0xF25BE857u, 0x9BC17CE7u, 0xC8B86851u, 0x64095221u), uint4(0xADF428FFu, 0xA3977109u, 0x745ED837u, 0x9CDC88F5u), v.c1));
        }
