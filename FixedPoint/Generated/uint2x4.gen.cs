...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public partial struct uint2x4 : System.IEquatable<uint2x4>, IFormattable
    {
        ...
        {
            this.c0 = select(new uint2(0u), new uint2(1u), v);
            this.c1 = select(new uint2(0u), new uint2(1u), v);
            this.c2 = select(new uint2(0u), new uint2(1u), v);
            this.c3 = select(new uint2(0u), new uint2(1u), v);
        }
        ...
        {
            this.c0 = select(new uint2(0u), new uint2(1u), v.c0);
            this.c1 = select(new uint2(0u), new uint2(1u), v.c1);
            this.c2 = select(new uint2(0u), new uint2(1u), v.c2);
            this.c3 = select(new uint2(0u), new uint2(1u), v.c3);
        }
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(v.c0 * uint2(0x45A22087u, 0xFC104C3Bu) +
                        v.c1 * uint2(0x5FFF6B19u, 0x5E6CBF3Bu) +
                        v.c2 * uint2(0xB546F2A5u, 0xBBCF63E7u) +
                        v.c3 * uint2(0xC53F4755u, 0x6985C229u)) + 0xE133B0B3u;
        }
        ...
        {
            return (v.c0 * uint2(0xC3E0A3B9u, 0xFE31134Fu) +
                    v.c1 * uint2(0x712A34D7u, 0x9D77A59Bu) +
                    v.c2 * uint2(0x4942CA39u, 0xB40EC62Du) +
                    v.c3 * uint2(0x565ED63Fu, 0x93C30C2Bu)) + 0xDCAF0351u;
        }
