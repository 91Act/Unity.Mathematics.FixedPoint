...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(asuint(v.c0) * uint3(0x48125549u, 0xEEE2123Bu, 0xE3AD9FE5u) +
                        asuint(v.c1) * uint3(0xCE1CF8BFu, 0x7BE39F3Bu, 0xFAB9913Fu) +
                        asuint(v.c2) * uint3(0xB4501269u, 0xE04B89FDu, 0xDB3DE101u)) + 0x7B6D1B4Bu;
        }
        ...
        {
            return (asuint(v.c0) * uint3(0x58399E77u, 0x5EAC29C9u, 0xFC6014F9u) +
                    asuint(v.c1) * uint3(0x6BF6693Fu, 0x9D1B1D9Bu, 0xF842F5C1u) +
                    asuint(v.c2) * uint3(0xA47EC335u, 0xA477DF57u, 0xC4B1493Fu)) + 0xBA0966D3u;
        }
