...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(asuint(v.c0) * uint2(0x79725379u, 0xD6258E5Bu) +
                        asuint(v.c1) * uint2(0xEE390C97u, 0x9C8A2F05u) +
                        asuint(v.c2) * uint2(0x4DDC6509u, 0x7CF083CBu) +
                        asuint(v.c3) * uint2(0x5C4D6CEDu, 0xF9137117u)) + 0xE857DCE1u;
        }
        ...
        public static uint2 hashwide(Fp2x4 v)
        {
            return (asuint(v.c0) * uint2(0xF62213C5u, 0x9CDAA959u) +
                    ...
                    asuint(v.c2) * uint2(0xFD0847B9u, 0x8189A683u) +
                    asuint(v.c3) * uint2(0xB139D651u, 0xE7579997u)) + 0xEF7D56C7u;
        }
