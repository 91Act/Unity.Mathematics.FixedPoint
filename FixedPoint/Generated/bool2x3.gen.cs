...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(select(uint2(0xF9EA92D5u, 0xC2FAFCB9u), uint2(0x616E9CA1u, 0xC5C5394Bu), v.c0) + 
                        select(uint2(0xCAE78587u, 0x7A1541C9u), uint2(0xF83BD927u, 0x6A243BCBu), v.c1) + 
                        select(uint2(0x509B84C9u, 0x91D13847u), uint2(0x52F7230Fu, 0xCF286E83u), v.c2));
        }
        ...
        {
            return (select(uint2(0xE121E6ADu, 0xC9CA1249u), uint2(0x69B60C81u, 0xE0EB6C25u), v.c0) + 
                    select(uint2(0xF648BEABu, 0x6BDB2B07u), uint2(0xEF63C699u, 0x9001903Fu), v.c1) + 
                    select(uint2(0xA895B9CDu, 0x9D23B201u), uint2(0x4B01D3E1u, 0x7461CA0Du), v.c2));
        }
