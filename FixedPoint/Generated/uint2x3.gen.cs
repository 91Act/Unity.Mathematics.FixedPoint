...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(v.c0 * uint2(0x58399E77u, 0x5EAC29C9u) +
                        v.c1 * uint2(0xFC6014F9u, 0x6BF6693Fu) +
                        v.c2 * uint2(0x9D1B1D9Bu, 0xF842F5C1u)) + 0xA47EC335u;
        }
        ...
        {
            return (v.c0 * uint2(0xA477DF57u, 0xC4B1493Fu) +
                    v.c1 * uint2(0xBA0966D3u, 0xAFBEE253u) +
                    v.c2 * uint2(0x5B419C01u, 0x515D90F5u)) + 0xEC9F68F3u;
        }
