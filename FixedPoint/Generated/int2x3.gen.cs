...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(asuint(v.c0) * uint2(0xDFF4F563u, 0x7069770Du) +
                        asuint(v.c1) * uint2(0xD1224537u, 0xE99ED6F3u) +
                        asuint(v.c2) * uint2(0x48125549u, 0xEEE2123Bu)) + 0xE3AD9FE5u;
        }
        ...
        {
            return (asuint(v.c0) * uint2(0xCE1CF8BFu, 0x7BE39F3Bu) +
                    asuint(v.c1) * uint2(0xFAB9913Fu, 0xB4501269u) +
                    asuint(v.c2) * uint2(0xE04B89FDu, 0xDB3DE101u)) + 0x7B6D1B4Bu;
        }
