...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public partial struct uint4x4 : System.IEquatable<uint4x4>, IFormattable
    {
        ...
        public uint4x4(bool v)
        {
            ...
            this.c3 = select(new uint4(0u), new uint4(1u), v);
        }
        ...
        public uint4x4(bool4x4 v)
        {
            ...
            this.c3 = select(new uint4(0u), new uint4(1u), v.c3);
        }
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(v.c0 * uint4(0xA47EC335u, 0xA477DF57u, 0xC4B1493Fu, 0xBA0966D3u) +
                        v.c1 * uint4(0xAFBEE253u, 0x5B419C01u, 0x515D90F5u, 0xEC9F68F3u) +
                        v.c2 * uint4(0xF9EA92D5u, 0xC2FAFCB9u, 0x616E9CA1u, 0xC5C5394Bu) +
                        v.c3 * uint4(0xCAE78587u, 0x7A1541C9u, 0xF83BD927u, 0x6A243BCBu)) + 0x509B84C9u;
        }
        ...
        {
            return (v.c0 * uint4(0x91D13847u, 0x52F7230Fu, 0xCF286E83u, 0xE121E6ADu) +
                    v.c1 * uint4(0xC9CA1249u, 0x69B60C81u, 0xE0EB6C25u, 0xF648BEABu) +
                    v.c2 * uint4(0x6BDB2B07u, 0xEF63C699u, 0x9001903Fu, 0xA895B9CDu) +
                    v.c3 * uint4(0x9D23B201u, 0x4B01D3E1u, 0x7461CA0Du, 0x79725379u)) + 0xD6258E5Bu;
        }
