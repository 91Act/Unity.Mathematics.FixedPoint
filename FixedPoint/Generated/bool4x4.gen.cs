...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(select(uint4(0xEE390C97u, 0x9C8A2F05u, 0x4DDC6509u, 0x7CF083CBu), uint4(0x5C4D6CEDu, 0xF9137117u, 0xE857DCE1u, 0xF62213C5u), v.c0) + 
                        select(uint4(0x9CDAA959u, 0xAA269ABFu, 0xD54BA36Fu, 0xFD0847B9u), uint4(0x8189A683u, 0xB139D651u, 0xE7579997u, 0xEF7D56C7u), v.c1) + 
                        select(uint4(0x66F38F0Bu, 0x624256A3u, 0x5292ADE1u, 0xD2E590E5u), uint4(0xF25BE857u, 0x9BC17CE7u, 0xC8B86851u, 0x64095221u), v.c2) + 
                        select(uint4(0xADF428FFu, 0xA3977109u, 0x745ED837u, 0x9CDC88F5u), uint4(0xFA62D721u, 0x7E4DB1CFu, 0x68EEE0F5u, 0xBC3B0A59u), v.c3));
        }
        ...
        {
            return (select(uint4(0x816EFB5Du, 0xA24E82B7u, 0x45A22087u, 0xFC104C3Bu), uint4(0x5FFF6B19u, 0x5E6CBF3Bu, 0xB546F2A5u, 0xBBCF63E7u), v.c0) + 
                    select(uint4(0xC53F4755u, 0x6985C229u, 0xE133B0B3u, 0xC3E0A3B9u), uint4(0xFE31134Fu, 0x712A34D7u, 0x9D77A59Bu, 0x4942CA39u), v.c1) + 
                    select(uint4(0xB40EC62Du, 0x565ED63Fu, 0x93C30C2Bu, 0xDCAF0351u), uint4(0x6E050B01u, 0x750FDBF5u, 0x7F3DD499u, 0x52EAAEBBu), v.c2) + 
                    select(uint4(0x4599C793u, 0x83B5E729u, 0xC267163Fu, 0x67BC9149u), uint4(0xAD7C5EC1u, 0x822A7D6Du, 0xB492BF15u, 0xD37220E3u), v.c3));
        }
