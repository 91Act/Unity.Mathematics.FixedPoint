...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(asuint(v.c0) * uint3(0xB8B208C7u, 0x5D3ED947u, 0x4473BBB1u) +
                        asuint(v.c1) * uint3(0xCBA11D5Fu, 0x685835CFu, 0xC3D32AE1u)) + 0xB966942Fu;
        }
        ...
        {
            return (asuint(v.c0) * uint3(0xFE9856B3u, 0xFA3A3285u, 0xAD55999Du) +
                    asuint(v.c1) * uint3(0xDCDD5341u, 0x94DDD769u, 0xA1E92D39u)) + 0x4583C801u;
        }
