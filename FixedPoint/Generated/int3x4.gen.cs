...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public partial struct int3x4 : System.IEquatable<int3x4>, IFormattable
    {
        ...
        {
            this.c0 = select(new int3(0), new int3(1), v);
            this.c1 = select(new int3(0), new int3(1), v);
            this.c2 = select(new int3(0), new int3(1), v);
            this.c3 = select(new int3(0), new int3(1), v);
        }
        ...
        {
            this.c0 = select(new int3(0), new int3(1), v.c0);
            this.c1 = select(new int3(0), new int3(1), v.c1);
            this.c2 = select(new int3(0), new int3(1), v.c2);
            this.c3 = select(new int3(0), new int3(1), v.c3);
        }
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(asuint(v.c0) * uint3(0x6E050B01u, 0x750FDBF5u, 0x7F3DD499u) +
                        asuint(v.c1) * uint3(0x52EAAEBBu, 0x4599C793u, 0x83B5E729u) +
                        asuint(v.c2) * uint3(0xC267163Fu, 0x67BC9149u, 0xAD7C5EC1u) +
                        asuint(v.c3) * uint3(0x822A7D6Du, 0xB492BF15u, 0xD37220E3u)) + 0x7AA2C2BDu;
        }
        ...
        {
            return (asuint(v.c0) * uint3(0xE16BC89Du, 0x7AA07CD3u, 0xAF642BA9u) +
                    asuint(v.c1) * uint3(0xA8F2213Bu, 0x9F3FDC37u, 0xAC60D0C3u) +
                    asuint(v.c2) * uint3(0x9263662Fu, 0xE69626FFu, 0xBD010EEBu) +
                    asuint(v.c3) * uint3(0x9CEDE1D1u, 0x43BE0B51u, 0xAF836EE1u)) + 0xB130C137u;
        }
