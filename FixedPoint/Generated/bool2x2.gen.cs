...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(select(uint2(0xD4DFF6D3u, 0xCB634F4Du), uint2(0x9B13B92Du, 0x4ABF0813u), v.c0) + 
                        select(uint2(0x86068063u, 0xD75513F9u), uint2(0x5AB3E8CDu, 0x676E8407u), v.c1));
        }
        ...
        {
            return (select(uint2(0xB36DE767u, 0x6FCA387Du), uint2(0xAF0F3103u, 0xE4A056C7u), v.c0) + 
                    select(uint2(0x841D8225u, 0xC9393C7Du), uint2(0xD42EAFA3u, 0xD9AFD06Du), v.c1));
        }
