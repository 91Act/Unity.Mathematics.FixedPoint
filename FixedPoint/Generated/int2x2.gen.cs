...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(asuint(v.c0) * uint2(0x5F17300Du, 0x670D6809u) +
                        asuint(v.c1) * uint2(0x7AF32C49u, 0xAE131389u)) + 0x5D1B165Bu;
        }
        ...
        {
            return (asuint(v.c0) * uint2(0x87096CD7u, 0x4C7F6DD1u) +
                    asuint(v.c1) * uint2(0x4822A3E9u, 0xAAC3C25Du)) + 0xD21D0945u;
        }
