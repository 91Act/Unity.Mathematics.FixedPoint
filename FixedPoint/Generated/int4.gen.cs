...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(asuint(v) * uint4(0x88FCAB2Du, 0x614DA60Du, 0x5BA2C50Bu, 0x8C455ACBu)) + 0xCD266C89u;
        }
        ...
        {
            return (asuint(v) * uint4(0xF1852A33u, 0x77E35E77u, 0x863E3729u, 0xE191B035u)) + 0x68586FAFu;
        }
