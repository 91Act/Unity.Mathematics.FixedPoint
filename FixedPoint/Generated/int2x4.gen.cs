...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public partial struct int2x4 : System.IEquatable<int2x4>, IFormattable
    {
        ...
        {
            this.c0 = select(new int2(0), new int2(1), v);
            this.c1 = select(new int2(0), new int2(1), v);
            this.c2 = select(new int2(0), new int2(1), v);
            this.c3 = select(new int2(0), new int2(1), v);
        }
        ...
        {
            this.c0 = select(new int2(0), new int2(1), v.c0);
            this.c1 = select(new int2(0), new int2(1), v.c1);
            this.c2 = select(new int2(0), new int2(1), v.c2);
            this.c3 = select(new int2(0), new int2(1), v.c3);
        }
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(asuint(v.c0) * uint2(0x66F38F0Bu, 0x624256A3u) +
                        asuint(v.c1) * uint2(0x5292ADE1u, 0xD2E590E5u) +
                        asuint(v.c2) * uint2(0xF25BE857u, 0x9BC17CE7u) +
                        asuint(v.c3) * uint2(0xC8B86851u, 0x64095221u)) + 0xADF428FFu;
        }
        ...
        {
            return (asuint(v.c0) * uint2(0xA3977109u, 0x745ED837u) +
                    asuint(v.c1) * uint2(0x9CDC88F5u, 0xFA62D721u) +
                    asuint(v.c2) * uint2(0x7E4DB1CFu, 0x68EEE0F5u) +
                    asuint(v.c3) * uint2(0xBC3B0A59u, 0x816EFB5Du)) + 0xA24E82B7u;
        }
