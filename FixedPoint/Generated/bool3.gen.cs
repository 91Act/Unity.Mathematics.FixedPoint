...
namespace Unity.Mathematics.FixedPoint
{
    ...
    public static partial class MathFp
    {
        ...
        {
            return csum(select(uint3(0x8C4CA03Fu, 0xB8D969EDu, 0xAC5DB57Bu), uint3(0xA91A02EDu, 0xB3C49313u, 0xF43A9ABBu), v));
        }
        ...
        {
            return (select(uint3(0x84E7E01Bu, 0x8E055BE5u, 0x6E624EB7u), uint3(0x7383ED49u, 0xDD49C23Bu, 0xEBD0D005u), v));
        }
